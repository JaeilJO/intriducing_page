import AppreciateSection from '@/components/contents/AppreciateSection';
...
const anchors: Anchors[] = [
    ...
    { key: 3, title: 'Appriciate', target_id: 'appriciate', in_navigation: false, content: <AppreciateSection /> },
